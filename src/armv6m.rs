...
pub const SYSTICK_FREQUENCY_HZ: u32 = 32_000_000;
...
pub const IRQ_PRIORITY_GRANULARITY: u8 = 64;

/// The maximum priority of an interrupt. It has the smallest numerical value.
pub const IRQ_MAX_PRIORITY: u8 = 0 * IRQ_PRIORITY_GRANULARITY;

/// The higher priority of an interrupt. Defined for convenience.
pub const IRQ_HIGH_PRIORITY: u8 = 0 * IRQ_PRIORITY_GRANULARITY;

/// The normal priority of an interrupt. Defined for convenience.
pub const IRQ_NORMAL_PRIORITY: u8 = 1 * IRQ_PRIORITY_GRANULARITY;

/// The lower priority of an interrupt. Defined for convenience.
pub const IRQ_LOW_PRIORITY: u8 = 2 * IRQ_PRIORITY_GRANULARITY;

/// The minimum priority of an interrupt. It has the largest numerical value.
pub const IRQ_MIN_PRIORITY: u8 = 2 * IRQ_PRIORITY_GRANULARITY;
...
pub const SVC_NORMAL_PRIORITY: u8 = 3 * IRQ_PRIORITY_GRANULARITY;
...
pub const PENDSV_PRIORITY: u8 = 3 * IRQ_PRIORITY_GRANULARITY;

/// The priority of SysTick interrupt.
pub const SYSTICK_PRIORITY: u8 = 2 * IRQ_PRIORITY_GRANULARITY;
